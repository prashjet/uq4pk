...
def simulate(snr, f_im=None, theta_noise=0.05, downsampling: int=1) -> ExperimentData:
    """
    ...
    experiment_data = ExperimentData(y=y, y_sd=y_sd, f_true=f_true, f_ref=f_true, theta_true=theta_v, theta_guess=theta_guess,
