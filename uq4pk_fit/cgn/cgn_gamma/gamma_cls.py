...
class CLS:
    """
    Represents a linearly-constrained regularized least-squares problem with gamma-prior on the regularization
    parameter.
    min_(x, alpha) (||R(H x - y)||_2^2 + alpha * ||P(x - m)||_2^2 - log gamma(alpha)) / scale
