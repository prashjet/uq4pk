...
class Problem:
    ...
    def __init__(self, parameters: List[Parameter], fun: callable, jac: callable,
                 q: Union[np.ndarray, RegularizationOperator] = None, constraints: List[LinearConstraint] = None,
                 scale: float = 1.):
        """
    ...
    @constraints.setter
    def constraints(self, value: List[LinearConstraint]):
    ...
    def _check_input(self, parameters: List[Parameter], fun: callable, jac: callable,
                     ...
                     constraints: Union[List[LinearConstraint], None], scale: float):
    ...
    def _check_constraints(self, constraints: List[LinearConstraint], parameters: List[Parameter]):
