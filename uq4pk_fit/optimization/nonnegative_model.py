...
from uq4pk_fit.operators.regop import RegularizationOperator
...
class NonnegativeLinearModel:
    ...
    def fit(self):
        ...
        minimize ||P_error(Gf - _y)||_2^2 + beta * ||P_f(f - f_bar)||_2^2.
        ...
        optimization_problem = CLS(h=h,y=y, lb=self._lb, scale=self._scaling_factor)
        # Solve CLS.
        f_min = cls_solve(optimization_problem)
        return f_min
