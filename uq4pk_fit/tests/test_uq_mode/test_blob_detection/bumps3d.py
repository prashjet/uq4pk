...
from uq4pk_fit.tests.test_uq_mode.test_blob_detection.plotty_blobby import plotty_blobby

LOC = "test_blob_detection/data"
...
def do_3d():
    ...
    plotty_blobby(image=map_image, blobs=blob_list)
    plt.show()
