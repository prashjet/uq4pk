...
from uq4pk_fit.special_operators import SecondDerivative, DiscreteLaplacian, NormalizedLaplacian
...
def test_2d():
    ...
    upper = np.loadtxt("data/test_upper.csv", delimiter=",")
    # Load Laplacian
    lap = DiscreteLaplacian(m=lower.shape[0], n=lower.shape[1]).mat
