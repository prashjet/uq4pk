...
def adaptive_fci(alpha: float, model: LinearModel, x_map: np.ndarray, filter_functions: Sequence[FilterFunction],
    ...
    affine_evaluation_map_list = [filter_and_discretization_to_evaluation_map(ffunction, discretization, x_map,
                                                                              weights=weights)
